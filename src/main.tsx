...
import { FormControlLabel, Switch, Grid, Collapse, TextField, Checkbox } from './components'
  ...
  return (
    ...
    <div className="lhasa_editor" style={{ backgroundColor: "transparent"}}>
      <Grid container columns={2}>
        <Grid size={1}>
          <FormControlLabel
            control={<Switch checked={showLhasa} onChange={() => setShowLhasa(!showLhasa)} />}
            label={"Show Lhasa"}
          />
        </Grid>
        <Grid size={1}>
        ...
        <Grid size={1}>
          <FormControlLabel
            control={<Switch checked={showFooter} onChange={() => setShowFooter(!showFooter)} />}
            label={"Show Footer"}
          />
        </Grid>
        <Grid size={1}>
          <FormControlLabel
            control={<Switch checked={showTopPanel} onChange={() => setShowTopPanel(!showTopPanel)} />}
            label={"Show Top Panel"}
          />
        </Grid>
        <Grid size={1}>
          <FormControlLabel
            control={<Switch checked={showSizingConstraints} onChange={() => setShowSizingConstraints(!showSizingConstraints)} />}
            label={"Sizing Constraints"}
          />
        </Grid>
        <Grid size={1}>
          <FormControlLabel
            control={<Switch checked={nameOfHostProgramUsed} onChange={() => setNameOfHostProgramUsed(!nameOfHostProgramUsed)} />}
            label={<div>
